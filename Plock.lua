...
function vu492.NewWindow(_, _, p508, p509)
    ...
    v519.Text = "Desplock HUB<font color=\'rgb(128,0,128)\'> KING LEGACY</font>"
    v519.RichText = true
...
v1074:MultiDropdown("Select World Boss to Hop", {
    v458("Jack o lantern [Lv. 10000]"),
    v458("King Samurai [Lv. 3500]"),
    v458("Dragon [Lv. 5000]"),
    v458("Ms. Mother [Lv. 7500]"),
    v458("Lord of Saber [Lv. 8500]"),
    v458("Bushido Ape [Lv. 5000]")
...
local v1142 = v996:AddSection("Settings", "Script Made By jay#0050", "Join Desplock Hub Discord For Updates! \nuse at your own risk.", "http://www.roblox.com/asset/?id=6031233840")
...
v1142:Slider("Hold Z", 0, 100, vu457.Z, function(p1175)
    vu457.Z = p1175
    SaveSettings()
end)
v1142:Slider("Hold X", 0, 100, vu457.X, function(p1176)
    vu457.X = p1176
    SaveSettings()
end)
v1142:Slider("Hold C", 0, 100, vu457.C, function(p1177)
    vu457.C = p1177
    SaveSettings()
end)
v1142:Slider("Hold V", 0, 100, vu457.V, function(p1178)
    vu457.V = p1178
    SaveSettings()
end)
v1142:Slider("Hold B", 0, 100, vu457.B, function(p1179)
    vu457.B = p1179
    SaveSettings()
end)
v1142:Slider("Hold E", 0, 100, vu457.E, function(p1180)
    vu457.E = p1180
    SaveSettings()
end)
local vu1181 = 1
